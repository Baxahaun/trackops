...
function parseArgs(args) {
  const options = { locale: null, name: null, withOpera: false, phases: null, noBootstrap: false };
...
async function cmdInit(args) {
  ...
  if (options.withOpera) {
    ...
    await opera.install(root, { locale: options.locale, bootstrap: !options.noBootstrap });
